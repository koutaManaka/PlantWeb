...
<template>
    <div class="building">
        <div class="flex">
            <div class="picture">
                <h2 class="font_1">欢迎登录智慧种植系统</h2>
                <el-button type="primary" round class="regiBtn" @click="jump">还没有账户?点击注册</el-button>
            </div>
            <div class="my-login">
                <div class="font_2">LOGIN</div>
                <div class="line"></div>
                <el-form :model="loginForm" :rules="rules" ref="FormRef" label-width="55px" class="top">
                    <el-form-item label="" prop="username" style="margin-top: 10px">
                        <el-row justify="center">
                            ...
                            <el-col :span="22">
                                <el-input class="user" placeholder="请输入用户名" v-model="loginForm.username">
                                </el-input>
                            </el-col>
                        </el-row>
                    </el-form-item>
                    ...
                    <router-link to="/forget" class="font_3">忘记密码?</router-link>
                </el-form>
            </div>
        </div>
    </div>
